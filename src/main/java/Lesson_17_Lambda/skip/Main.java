package Lesson_17_Lambda.skip;

// skip - как limit ограничивает количество элементов в стриме, пропуская первый
...
public class Main {
    public static void main(String[] args) {
        ...
        studentList.stream().filter(student -> student.getAge() > 52).skip(1).forEach(System.out::println);   // пропускает 1 го
