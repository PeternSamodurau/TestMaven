...
public class SummingNumbersSleep implements Runnable {
    ...
    public SummingNumbersSleep(int fromNumber, int toNumber) {
    ...
    public void run() {
       ...
       MainSummingNumbersSleep.printThreadNameAndNumber(resultNumber);
    }
}
