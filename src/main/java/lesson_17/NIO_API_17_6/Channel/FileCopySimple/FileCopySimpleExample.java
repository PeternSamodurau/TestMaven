package lesson_17.NIO_API_17_6.Channel.FileCopySimple;
...
public class FileCopySimpleExample {
    ...
    public static void main(String[] args) {
        ...
        Path inputPath = Path.of("lesson_17/Parsing_from_Object_to_JSONfile_Jackson/data/input.txt");                //данные из файла
        Path outputPath = Path.of("lesson_17/Parsing_from_Object_to_JSONfile_Jackson/data/output.txt");              // данные в файл создали копию!!!
